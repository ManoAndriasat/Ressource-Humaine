...
namespace RessourceHumaine
{
    public class QuestionModel
    {
        ...
        public  QuestionModel GetQuestionByID(List<QuestionModel> questions, string ID_Question)
        {
            // Parcourir la liste d'objets QuestionModel pour trouver l'objet correspondant à l'ID de la question
            foreach (var question in questions)
            {
                if (question.ID_Question == ID_Question)
                {
                    return question; // Renvoyer l'objet trouvé
                }
            }
